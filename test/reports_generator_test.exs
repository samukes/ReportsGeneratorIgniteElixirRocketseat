defmodule ReportsGeneratorTest do
  ...
  describe "build_from_many/1" do
    ...
    test "when a file list is not provided get error" do
      file_names = "banana"
  ...
  describe "fecth_higher_cost/2" do
    ...
    test "when the option is 'food', returns the most consumed food" do
      file_name = "report_test.csv"
    ...
    test "when invalid option, returns an error" do
      file_name = "report_test.csv"

      response =
        file_name
        |> ReportsGenerator.build()
        |> ReportsGenerator.fecth_higher_cost("bananas")
